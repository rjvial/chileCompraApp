...
def _row(cluster, price, rut, date="2026-01-01"):
    return {"cluster": cluster, "category": "foley", "date": date, "rut": rut,
            "unit_price": price, "normalized_price": price, "currency": "CLP"}


def test_summarize_counts_competitors_and_price_stats():
    rows = [
        _row("foley|calibre=16fr", 100, "A", "2026-01-01"),
        _row("foley|calibre=16fr", 300, "A", "2026-03-01"),
        _row("foley|calibre=16fr", 200, "B", "2026-02-01"),
